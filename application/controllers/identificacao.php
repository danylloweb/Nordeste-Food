...
class Identificacao extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->template->set('body_class', 'pg-interna pg-finalizar');
    ...
    {
        $this->session->unset_userdata('log_cliente');
    ...
    public function cadastro() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $this->form_validation->set_rules('cli_nome_empresa', 'Nome da Empresa', 'required|trim|strip_tags');
            ...
            $this->form_validation->set_rules('cli_bairro', 'Bairro', 'required|trim|strip_tags');
    ...
    public function recovery() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (!$this->cliente->validar_cliente(array('cli_email' => $this->input->post('cli_email')))) {
                $this->session->set_flashdata('erro', 'Não existe esse email no sistema');
                redirect('identificacao');
            } else {
                ...
                $this->session->set_flashdata('oklog', 'Senha gerada com sucesso. Verifique em seu e-mail');
                redirect('identificacao');
            }
        }
    }
