...
class Pagamento extends CI_Controller {
    ...
    public function processar() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $pedido = array(
                'ped_cli_id' => $sess_cliente['id_user'],
                'ped_valor_pedido' => $this->cart->total(),
                'ped_data_criacao' => date("Y-m-d H:i:s"),
                'ped_status' => 'pendente',
                'ped_ip' => $_SERVER['REMOTE_ADDR'],
                'ped_dinheiro_troco' => $dadosPost['ped_dinheiro_troco'],
                'ped_tipo_pagamento' => $dadosPost['ped_tipo_pagamento']);
