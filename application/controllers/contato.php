...
class Contato extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->template->set('email', $config->conf_email);
    ...
    public function index() {
        ...
        $dados['phone1'] = $config->conf_phone_one;
        $dados['phone2'] = $config->conf_phone_two;
        $dados['endereco'] = $config->conf_adress;
        $dados['email'] = $config->conf_email;
