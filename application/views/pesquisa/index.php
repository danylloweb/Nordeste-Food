            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="content-conteudo">
                        <h1 class="titulos-1 page-title">Pesquisa de  <span>Satisfação</span></h1>
                        <p class="descricao-pag">Obrigado por escolher o Paraíba Refeições. Para aprimorarmos nossos serviços, por favor, dê sua opnião sobre nosso restaurante.</p>

                        <form action="http://nordestefoodservice.com.br/public/scripts/enviapesquisa.php" method="post" id="formPesquisaSatis">
                            <div class="row">
                                <div class="col-md-5">
                                    <span>&nbsp;</span>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-5"><strong>1) Ambientes</strong></div>
                                <div class="col-md-7">
                                    <span>
                            ...
                            <div class="row">
                                <div class="col-md-5"><strong>2) Atendimento</strong></div>
                                <div class="col-md-7">
                                    <span>
                            ...
                            <div class="row">
                                <div class="col-md-5"><strong>3) Qualidade dos Alimentos</strong></div>
                                <div class="col-md-7">
                                    <span>
                            ...
                            <div class="row">
                                <div class="col-md-5"><strong>4) Qualidade das Bebidas</strong></div>
                                <div class="col-md-7">
                                    <span>
                            ...
                            <div class="row">
                                <div class="col-md-5"><strong>5) Delivery </strong></div>
                                <div class="col-md-7">
                                    <span>
                            ...
                            <fieldset>
                                ...
                                <input type="submit" value="Enviar" class="pull-right botao btn-amarelo">
                                </div>
                            </fieldset>
                        </form>
