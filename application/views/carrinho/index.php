                                    ...
                                    <?php foreach ($this->cart->contents() as $cart): ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="col-md-10">
                                                    <?php echo $refeicao->ref_feijao ? $refeicao->ref_feijao . ' - ' : '' ?>
                                                    <?php echo $refeicao->ref_arroz ? $refeicao->ref_arroz : '' ?>
                                                    <?php echo $refeicao->ref_macarrao ? ' - ' . $refeicao->ref_macarrao : '' ?>
                                                    <?php echo $refeicao->ref_salada_um ? ' - ' . $refeicao->ref_salada_um : '' ?>
                                                    <?php echo $refeicao->ref_salada_dois ? ' - ' . $refeicao->ref_salada_dois : '' ?>
                                                    <?php echo $refeicao->ref_acompanhamento ? ' - ' . $refeicao->ref_acompanhamento : '' ?>
                                                    <?php echo $refeicao->ref_carne_um ? ' - ' . $refeicao->ref_carne_um : '' ?>
                                                    <?php echo $refeicao->ref_carne_dois ? ' - ' . $refeicao->ref_carne_dois : '' ?>
                                                    <?php echo $refeicao->ref_bebida ? ' - ' . $refeicao->ref_bebida : '' ?>
                                                    <?php echo $refeicao->ref_sobremesa ? ' - ' . $refeicao->ref_sobremesa : '' ?>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="col-md-6">
