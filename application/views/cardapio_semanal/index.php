<section id="wrap-centro" class="pg-interna">
    <div class="panel">
        <div class="container">
            <div class="text-center">
                <h2 class="panel-title">Cardápio</h2>
            </div>
            <div class="row">
                <div class="col-md-8">
    ...
    <div id="sid-right">
        <nav id="nav-interna">
            <ul class="nav-menu-lateral">
                <li class="activ"><a class="botao btn-amarelo" href="<?= site_url('cardapio_semanal') ?>">Cardápio</a></li>
                <li><a class="botao btn-amarelo" href="<?= site_url('alacartes') ?>">À la Carte</a></li>
            </ul>
        </nav>
