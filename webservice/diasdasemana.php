...
/*$sql_marmita = "SELECT * FROM marmita GROUP BY mar_dia_semana ORDER BY marmita.mar_data DESC 
LIMIT 0 , 6";*/
...
$cardapio_semana = array();
    ...
    $sql_bebida = "SELECT b.beb_nome, b.beb_preco FROM bebida b";
    $sql_sobre = "SELECT s.sob_nome, s.sob_preco FROM sobremesa s";
...
//echo preg_replace("/\\\\u([a-f0-9]{4})/e", "iconv('UCS-4LE','UTF-8',pack('V', hexdec('U$1')))", json_encode(utf8($resultado)));
?>
